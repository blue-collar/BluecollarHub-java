...
(
  ...
  type int null comment '类型：0文章，1其他(供后续扩展)',
  `rank` int null comment '级别(一级、二级、三级)',
  parent_id int default '0' null comment '父主键',
  constraint operation_category_id_uindex unique (id)
);
...
(
  ...
  type int null comment '所属类别：0文章，1其他类别'
)comment '标签';
