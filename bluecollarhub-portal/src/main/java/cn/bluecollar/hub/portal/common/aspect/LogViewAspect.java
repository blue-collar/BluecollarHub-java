package cn.bluecollar.hub.portal.common.aspect;

import cn.bluecollar.hub.common.util.HttpContextUtils;
import cn.bluecollar.hub.common.util.IPUtils;
import cn.bluecollar.hub.common.util.JsonUtils;
import cn.bluecollar.hub.mapper.article.ArticleMapper;
import cn.bluecollar.hub.mapper.log.LogViewMapper;
...
public class LogViewAspect {
    ...
    @Pointcut("@annotation(cn.bluecollar.hub.portal.common.annotation.LogView)")
    ...
    private void saveViewLog(ProceedingJoinPoint joinPoint, long time) {
        ...
        cn.bluecollar.hub.entity.log.LogView viewLogEntity = new cn.bluecollar.hub.entity.log.LogView();
