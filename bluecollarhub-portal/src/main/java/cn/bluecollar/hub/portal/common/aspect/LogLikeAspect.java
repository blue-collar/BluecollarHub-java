...
import cn.bluecollar.hub.mapper.log.LogLikeMapper;
...
public class LogLikeAspect {
    ...
    @Pointcut("@annotation(cn.bluecollar.hub.portal.common.annotation.LogLike)")
    ...
    private void saveLogLike(ProceedingJoinPoint joinPoint, long time) {
        ...
        cn.bluecollar.hub.entity.log.LogLike logLikeEntity = new cn.bluecollar.hub.entity.log.LogLike();
