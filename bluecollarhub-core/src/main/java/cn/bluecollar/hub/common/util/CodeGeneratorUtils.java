...
public class CodeGeneratorUtils {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/bchub?allowMultiQueries=true&useUnicode=true&characterEncoding=UTF-8&useSSL=false");
        dsc.setDriverName("com.mysql.jdbc.Driver");
        dsc.setUsername("root");
        dsc.setPassword("csy123456");
        mpg.setDataSource(dsc);

        // 包配置
        PackageConfig pc = new PackageConfig();
        pc.setParent("cn.bluecollar.hub.manage");
        ...
        InjectionConfig cfg = new InjectionConfig() {
            ...
            public void initMap() {
                ...
                map.put("basePath", "cn.bluecollar.hub");
                this.setMap(map);
            }
        };
        ...
        strategy.setSuperControllerClass("cn.bluecollar.hub.manage.sys.controller.AbstractController");
